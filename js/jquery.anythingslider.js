    ...
    // Add a reverse reference to the DOM object
      ...
      // Top and tail the list with 'visible' number of items, top has the last section, and tail has the first
			...
			// Ensures any cloned elements with ID's have unique ID's
			  ...
			  if ($itemClone.prop("id") != "") {
          base.$items.filter(':first').before($itemClone.prop('id', ($itemClone.prop('id') + "-cloned")));
        } else {
        ...
        if ($itemClone.prop("id") != '') {
          base.$items.filter(':last' ).after($itemClone.prop('id', ($itemClone.prop('id') + "-cloned")));
        } else {
        ...
        base.$items = base.$slider.find('> li'); // reselect
			...
			// If pauseOnClick then add click effects
			if (base.options.pauseOnClick) {
				base.$el.click(function() {
					base.startStop(false);
				});
				// special condition for embedded iframes
